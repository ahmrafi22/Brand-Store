    ...
    <div className="max-w-7xl mx-auto p-4 sm:p-6">
      ...
      {!orderDetails ? (
        <div className="flex justify-center">
          <p className="text-2xl  ring-2 ring-offset-8 ring-gray-400 italic px-4 py-2 mb-20 mt-10">
        ...
        <div className="p-4 sm:p-6 rounded-lg border border-gray-300">
          <div className="flex flex-col sm:flex-row justify-between mb-8">
            ...
            <div className="flex flex-col items-start sm:items-end mt-4 sm:mt-0">
              <span
                ...
                } px-3 py-2 rounded-[12px] text-sm font-medium mb-2`}
              >
                ...
                <tbody>
                    {orderDetails.orderItems.map((item) => (
                        <tr key={item.id}>
                            ...
                            <Link className="text-blue-500/70 hover:underline" to= {`/product/${item.id}`}>{item.name}</Link>
                            </td>
          ...
          <Link to="/my-orders" className="text-blue-500 hover:underline mt-4">Back to my oders</Link>
        </div>
      )}
    </div>
  );
